...
set_property LOC SLICE_X6Y0 [get_cells {genblk1[0].jc_reg[0]}]



set_property BEL B6LUT [get_cells osc0/b_inferred_i_11]
set_property LOC SLICE_X6Y1 [get_cells osc0/b_inferred_i_11]


set_property BEL CFF [get_cells {genblk1[2].jc_reg[2]}]
set_property LOC SLICE_X6Y0 [get_cells {genblk1[2].jc_reg[2]}]
set_property BEL B5FF [get_cells {genblk1[7].jc_reg[7]}]
set_property LOC SLICE_X6Y0 [get_cells {genblk1[7].jc_reg[7]}]
set_property BEL C5FF [get_cells {genblk1[1].jc_reg[1]}]
set_property LOC SLICE_X6Y0 [get_cells {genblk1[1].jc_reg[1]}]
set_property BEL BFF [get_cells {genblk1[3].jc_reg[3]}]
set_property LOC SLICE_X6Y0 [get_cells {genblk1[3].jc_reg[3]}]
set_property BEL DFF [get_cells {genblk1[4].jc_reg[4]}]
set_property LOC SLICE_X6Y0 [get_cells {genblk1[4].jc_reg[4]}]
set_property BEL A5FF [get_cells {genblk1[5].jc_reg[5]}]
set_property LOC SLICE_X6Y0 [get_cells {genblk1[5].jc_reg[5]}]
set_property BEL AFF [get_cells {genblk1[6].jc_reg[6]}]
set_property LOC SLICE_X6Y0 [get_cells {genblk1[6].jc_reg[6]}]
set_property BEL A6LUT [get_cells osc0/b_inferred_i_2]
set_property LOC SLICE_X6Y1 [get_cells osc0/b_inferred_i_2]
set_property BEL A5LUT [get_cells osc0/b_inferred_i_4]
set_property LOC SLICE_X6Y2 [get_cells osc0/b_inferred_i_4]
set_property BEL B5LUT [get_cells osc0/b_inferred_i_6]
set_property LOC SLICE_X6Y2 [get_cells osc0/b_inferred_i_6]
set_property BEL B6LUT [get_cells osc0/b_inferred_i_7]
set_property LOC SLICE_X7Y1 [get_cells osc0/b_inferred_i_7]
set_property BEL D6LUT [get_cells osc0/b_inferred_i_9]
set_property LOC SLICE_X7Y1 [get_cells osc0/b_inferred_i_9]
set_property BEL A6LUT [get_cells osc0/b_inferred_i_1]
set_property LOC SLICE_X7Y1 [get_cells osc0/b_inferred_i_1]
set_property BEL C6LUT [get_cells osc0/b_inferred_i_10]
set_property LOC SLICE_X6Y1 [get_cells osc0/b_inferred_i_10]
set_property BEL D6LUT [get_cells osc0/b_inferred_i_3]
set_property LOC SLICE_X6Y1 [get_cells osc0/b_inferred_i_3]
set_property BEL C5LUT [get_cells osc0/b_inferred_i_5]
set_property LOC SLICE_X6Y2 [get_cells osc0/b_inferred_i_5]

...
set_property LOC SLICE_X1Y0 [get_cells osc0/b_inferred_i_4]
set_property LOC SLICE_X1Y1 [get_cells osc0/b_inferred_i_5]
set_property LOC SLICE_X1Y2 [get_cells osc0/b_inferred_i_6]
set_property LOC SLICE_X0Y2 [get_cells osc0/b_inferred_i_7]
set_property LOC SLICE_X1Y2 [get_cells osc0/b_inferred_i_8]
set_property LOC SLICE_X1Y1 [get_cells osc0/b_inferred_i_9]
set_property LOC SLICE_X1Y0 [get_cells osc0/b_inferred_i_10]
...
## PMOD Header JB
set_property -dict { PACKAGE_PIN V29   IOSTANDARD LVCMOS33 } [get_ports { q }]; #IO_L17P_T2_A14_D30_14 Sch=jb_p[1]
set_property -dict { PACKAGE_PIN V30   IOSTANDARD LVCMOS33 } [get_ports { ro_out }]; #IO_L17N_T2_A13_D29_14 Sch=jb_n[1]

...
set_property LOC SLICE_X1Y2 [get_cells {pw0/FSM_sequential_fsmState[0]_i_1}]
set_property BEL A6LUT [get_cells {pw0/FSM_sequential_fsmState[1]_i_1}]
set_property LOC SLICE_X1Y2 [get_cells {pw0/FSM_sequential_fsmState[1]_i_1}]
set_property BEL D6LUT [get_cells {pw0/FSM_sequential_fsmState[1]_i_2}]
set_property LOC SLICE_X1Y2 [get_cells {pw0/FSM_sequential_fsmState[1]_i_2}]
set_property BEL B6LUT [get_cells {pw0/FSM_sequential_fsmState[1]_i_3}]
set_property LOC SLICE_X1Y3 [get_cells {pw0/FSM_sequential_fsmState[1]_i_3}]
set_property BEL BFF [get_cells {pw0/FSM_sequential_fsmState_reg[0]}]
set_property LOC SLICE_X1Y2 [get_cells {pw0/FSM_sequential_fsmState_reg[0]}]
set_property BEL A6LUT [get_cells pw0/wrong_i_4]
set_property LOC SLICE_X1Y3 [get_cells pw0/wrong_i_4]
set_property BEL AFF [get_cells pw0/wrong_reg]
set_property LOC SLICE_X2Y2 [get_cells pw0/wrong_reg]
set_property BEL AFF [get_cells {pw0/FSM_sequential_fsmState_reg[1]}]
set_property LOC SLICE_X1Y2 [get_cells {pw0/FSM_sequential_fsmState_reg[1]}]
set_property BEL A6LUT [get_cells pw0/open_i_1]
set_property LOC SLICE_X1Y1 [get_cells pw0/open_i_1]
set_property BEL C6LUT [get_cells pw0/wrong_i_2]
set_property LOC SLICE_X1Y2 [get_cells pw0/wrong_i_2]
set_property BEL A6LUT [get_cells pw0/wrong_i_3]
set_property LOC SLICE_X2Y2 [get_cells pw0/wrong_i_3]
set_property BEL AFF [get_cells pw0/open_reg]
set_property LOC SLICE_X1Y1 [get_cells pw0/open_reg]
set_property BEL C5LUT [get_cells pw0/wrong_i_1]
set_property LOC SLICE_X1Y2 [get_cells pw0/wrong_i_1]

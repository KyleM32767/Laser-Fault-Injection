...
set_property BEL BFF [get_cells {pw0/FSM_sequential_fsmState_reg[1]}]
set_property LOC SLICE_X152Y1 [get_cells {pw0/FSM_sequential_fsmState_reg[1]}]
set_property BEL AFF [get_cells {pw0/FSM_sequential_fsmState_reg[0]}]
set_property LOC SLICE_X152Y1 [get_cells {pw0/FSM_sequential_fsmState_reg[0]}]
set_property BEL DFF [get_cells pw0/open_reg]
set_property LOC SLICE_X152Y1 [get_cells pw0/open_reg]
set_property BEL A6LUT [get_cells osc0/b_inferred_i_1]
set_property LOC SLICE_X153Y0 [get_cells osc0/b_inferred_i_1]
set_property BEL B6LUT [get_cells osc0/b_inferred_i_2]
set_property LOC SLICE_X153Y0 [get_cells osc0/b_inferred_i_2]
set_property BEL A6LUT [get_cells osc0/b_inferred_i_6]
set_property LOC SLICE_X151Y0 [get_cells osc0/b_inferred_i_6]
set_property BEL B6LUT [get_cells osc0/b_inferred_i_7]
set_property LOC SLICE_X151Y0 [get_cells osc0/b_inferred_i_7]
set_property BEL C6LUT [get_cells osc0/b_inferred_i_3]
set_property LOC SLICE_X153Y0 [get_cells osc0/b_inferred_i_3]
set_property BEL A6LUT [get_cells osc0/b_inferred_i_4]
set_property LOC SLICE_X152Y0 [get_cells osc0/b_inferred_i_4]
set_property BEL C6LUT [get_cells osc0/b_inferred_i_5]
set_property LOC SLICE_X151Y0 [get_cells osc0/b_inferred_i_5]
